 ...
 */
public abstract class RSAUtils2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(RSAUtils2.class);
    private static final String DEFAULT_SEED = "25621456";
...
//    private static final int KEY_SIZE = 1024;
    ...
    private static synchronized KeyPair generateKeyPair(String seed) {
        try {
            keyPairGen.initialize(KEY_SIZE, new SecureRandom((DateUtil.getCurrDate()+seed).getBytes()));
    ...
    private static String getRSAPairFilePath() {
        String urlPath = RSAUtils2.class.getResource("/").getPath();
